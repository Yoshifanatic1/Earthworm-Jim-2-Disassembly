; Note: Put your custom routine/data macros, references to them, and defines in this file from within the EWJ2_InsertIntegratedPatches and EWJ2_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro EWJ2_InsertIntegratedPatches()
...
macro EWJ2_ApplyPatchesPostAssembly()
